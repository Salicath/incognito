...
export default function SetupWizard() {
  ...
  const inputClass = "w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-xl w-full p-8">
        ...
        <div className="flex gap-2 mb-8">
          {steps.map((_, i) => (
            <div key={i} className={`h-1.5 flex-1 rounded-full ${i <= currentIndex ? "bg-indigo-600" : "bg-gray-200"}`} />
          ))}
        </div>
        ...
        {step === "password" && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">This encrypts your profile data. Choose something strong.</p>
        ...
        {step === "profile" && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">This is what we search for and include in removal requests.</p>
