...
import { Shield, LayoutDashboard, Send, Database, Search, Settings, LogOut, Menu, X, Moon, Sun, FileBarChart, Fingerprint, Inbox, Building2, Hourglass } from "lucide-react";
...
const navItems = [
  ...
  { to: "/controllers", icon: Building2, label: "Controllers" },
  { to: "/levers", icon: Fingerprint, label: "CPR Levers" },
  { to: "/statutory", icon: Hourglass, label: "Statutory" },
